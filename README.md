...
dependencies {
     // NeoForge
     implementation group: 'net.darkhax.gildedsherds', name: 'gildedsherds-neoforge-26.2', version: '26.2.0.0'
     // Fabric
     implementation group: 'net.darkhax.gildedsherds', name: 'gildedsherds-fabric-26.2', version: '26.2.0.0'
     // Common / MultiLoader / Vanilla / No Loader
     implementation group: 'net.darkhax.gildedsherds', name: 'gildedsherds-common-26.2', version: '26.2.0.0'
}
```
