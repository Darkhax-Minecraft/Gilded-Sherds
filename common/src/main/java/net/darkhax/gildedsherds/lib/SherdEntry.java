...
public class SherdEntry implements ItemLike {
    ...
    public SherdEntry(String type) {
        ...
        this.type = type;
        this.sherdPattern = ResourceKey.create(Registries.DECORATED_POT_PATTERNS, GildedSherdsCommon.location(type + "_pottery_pattern"));
        this.itemId = GildedSherdsCommon.location(type + "_pottery_sherd");
